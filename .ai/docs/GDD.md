...
- **Recolher Naves**: Ao controlar a Nave-Mãe, um botão na interface permite chamar a Nave de Exploração de volta. Ao chegar, a nave entra em uma órbita estável ao redor da Nave-Mãe. A ação deve ter um feedback visual no botão.
