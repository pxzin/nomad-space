...
1. Implementar engine de jogo 2D
2. Desenvolver sistema de física básica
3. Criar sistema de construção de bases
4. Implementar mecânicas de exploração
...
### Engines/Frameworks Considerados

- **Phaser.js**: Framework completo para jogos
- **PixiJS**: Renderização 2D de alta performance
- **Three.js**: Para elementos 3D futuros
- **Custom Engine**: Engine própria para controle total
